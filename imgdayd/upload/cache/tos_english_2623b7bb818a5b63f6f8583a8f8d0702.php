...
<head>
	<meta charset="UTF-8">
	<title>CF Image Host &lt;  - Terms of Service</title>
	<meta name="description" content="Terms of Service page for CF Image Host" />
...
<div id="msg"></div>		<div class="contentBox">
			<div id="tos">
				...
				<ul>
					<li>CF Image Host reserves the right to disable or delete any file which might compromise the security of our servers, uses excessive bandwidth, violates this Terms of Service or is otherwise considered undesirable (at our sole discretion).</li>
					...
					<li>CF Image Host does not allow the following types of files to be uploaded:						<ul>
					...
					<li>CF Image Host reserves the right to deny access to any user who uploads files that compromise the security of our servers, use excessive bandwidth or are otherwise deemed to be misusing the free file hosting service.</li>
					<li>CF Image Host reserves the right to modify these Terms of Service at any time without prior notification.</li>
				</ul>
				<br/><br/>
