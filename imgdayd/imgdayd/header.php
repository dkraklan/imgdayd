<?php ini_set('display_errors' , 1);error_reporting(E_ALL); if(!defined('cfih') or !cfih) exit("Direct access not permitted.");
/**************************************************************************************************************
 *
...
<div id="wrap">
	<div id="header" class="clear_both">
		...
		<div id="logo">
			<h1><a href="<?php get_url('index.php');?>" title="<?php get_site('title');?> <?php echo _T("site_menu_home");?>">
			<?php //get_site('title');?></a></h1>
			<h2><a href="#."><img src="img/logo.png" /></a> <?php //get_site('slogan');?></h2>
		</div>
